...
def main(argv):
    ...
    description = "Uploaded with AniDexPy by DameDesuYo"  # default description for the torrent use the -d arg to set this in command line.
  ...
  --debug\n  OPTIONAL: This will send the torrent and return all the variables recieved by AniDex. This will NOT actually upload the torrent and should only be used for testing.\n"""
    ...
    try:
        opts, args = getopt.getopt(argv, "ha:f:n:c:l:d:g:u:",
                                   ["file=", "apiurl=", "apikey=", "cat=", "name=", "group=", "lang=", "desc=", "batch",
                                    "hentai", "debug", "reencode", "private", "tt"])
